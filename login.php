...
<html class="bg-gray">
	...
	<body class="bg-gray">
		<div class="form-box" id="login-box">
    		<div class="header" style="font-weight: 400;"><img alt="CPTIGER" title="logo.jpg" src="images/logo.jpg"></div>
      		<form name="login" action="CustomerAuthenticate.php" method="post">
				...
				<div class="footer" >
					<button type="submit" class="btn bg-light-blue btn-block" onclick="return validateLoginDetails();" style="font-size: 16px; font=weight:500;"><?php  echo getTranslatedString('LBL_SIGN_IN');?></button>  
